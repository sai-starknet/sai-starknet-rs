use sai_starknet_provider::jsonrpc::{HttpTransport, JsonRpcClient};
use sai_starknet_provider::{Provider, ProviderError, ProviderRequestData, ProviderResponseData};
use sai_starknet_types::requests::{CallRequest, GetBlockTransactionCountRequest};
use sai_starknet_types::{
    ...
    DeployAccountTransaction, EthAddress, EventFilter, ExecuteInvocation, ExecutionResult, Felt,
    FunctionCall, Hash256, InvokeTransaction, MaybePreConfirmedBlockWithReceipts,
    MaybePreConfirmedBlockWithTxHashes, MaybePreConfirmedBlockWithTxs,
    MaybePreConfirmedStateUpdate, MsgFromL1, ResourceBounds, ResourceBoundsMapping, StarknetError,
    SyncStatusType, Transaction, TransactionFinalityStatus, TransactionReceipt, TransactionStatus,
    TransactionTrace,
};
    ...
    let eth_balance = rpc_client
        .call(
            &FunctionCall {
                ...
                .unwrap(),
                entry_point_selector: Felt::selector("balanceOf"),

...
use super::{ContractExecutionError, Felt, MerkleNode, SyncStatus, SyncStatusType};
...
mod block_id {
    ...
    use crate::{BlockId, BlockTag, ConfirmedBlockId};
...
mod enum_ser_impls {
    use crate::{
        ...
        InvokeTransaction, InvokeTransactionContent, Transaction, TransactionContent,

...
use crate::codec::{Decode, Encode, Error as CodecError, FeltWriter};
use sai_felt::Felt;
...
impl<'a> Decode<'a> for ByteArray {
        ...
        T: Iterator<Item = &'a Felt>,
    {
        ...
        for _ in 0..length {
            ...
            result.extend_from_slice(&full_slot.to_be_bytes()[1..]);
        }
        ...
        result
            .extend_from_slice(&pending_word.to_be_bytes()[(FELT_BYTE_SIZE - pending_word_len)..]);
